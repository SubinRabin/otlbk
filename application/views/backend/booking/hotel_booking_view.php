	...
	<div class="card">
		<div class="card-header text-uppercase" style="padding: 10px; border-bottom: 1px solid #ccc;">
			...
			<form id="bookingRemarkForm">
				...
				<textarea id="bookingRemark" name="bookingRemark" class="form-control"><?php echo $view[0]->remarks ?></textarea>
				<div class="row"> 
					<br>
					<div class="col-xs-12"> 
					<button type="button" id="bookingRemarkBtn" class="btn-sm btn-success pull-right">Update</button>
					</div>
					<br>
				</div>
			</form>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body" style="height: 300px;">
                	...
                	<div class="col-md-12 form-group">
	            		...
	            		<button type="button" data-dismiss="modal" id="reject_button" style="margin-left: 10px;" class="btn-sm btn-danger pull-right">No</button>
                	</div>
                	</div>
                </div>
            </div>

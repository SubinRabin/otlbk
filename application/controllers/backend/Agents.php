    ...
    // } else {
      foreach($agent->result() as $key => $r) {
        ...
        if($agentmenu[0]->delete!=0) {
            if ($r->delflg==0) {
                  $permission = '<a href="#" onclick="agentpermissionfun('.$r->id.',1);"  class="sb2-2-1-edit delete"><i class="fa fa-unlock-alt" aria-hidden="true"></i></a>';
            } else if ($r->delflg==2) {
                  $permission = '<a href="#" onclick="agentpermissionfun('.$r->id.',1);" class="sb2-2-1-edit delete"><i class="fa fa-check" aria-hidden="true"></i></a>
                  <a href="#" onclick="deletefun('.$r->id.');" data-toggle="modal" data-target="#myModal" class="sb2-2-1-edit delete"><i class="fa fa-trash-o red" aria-hidden="true"></i></a>';
            } else {
                  $permission = '<a href="#" onclick="deletefun('.$r->id.');" data-toggle="modal" data-target="#myModal" class="sb2-2-1-edit delete"><i class="fa fa-trash-o red" aria-hidden="true"></i></a>';
            }
        }else{
          $permission="";
        }

                ...
                if (array_sum($individual_discount)!=0) {
                  $tb52 .= '<tr>
                        ...
                        <td style="text-align:right;color:red;">
                          <small>
                          '.currency_type(agent_currency(),$array_wiDissumTotal).' '.agent_currency().'</small>
                        </td>
                      </tr>';
                }
                $tb52 .= '<tr>
  ...
  $cancelation = $this->Payment_Model->get_cancellation_terms($_REQUEST['id']); 
    ...
    public function bookingdataInsert($type,$data) {
        ...
        for ($i=0; $i < $tot_days ; $i++) {
          ...
          $discountCodes[$i] = DateWisediscountCode($dateOut,$data['hotel_id'],$data['room_id'],$data['contract_id'],'Room');
        }
